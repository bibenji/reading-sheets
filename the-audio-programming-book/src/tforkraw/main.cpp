...
/* based on tfork2.c */
/* usage tforwraw outfile.raw 30 440 44100 1 */
/* peut ensuite être importé dans audacity en float 32, petit boutiste, à importer deux fois pour avoir du son ??? */
...
/* SHORT is 16-bit audio ?, FLOAT is 32-bit audio */
...
int main(int argc, char** argv)
{
    ...
    /* normalized range always -jst scale by amp */
    start = 1.0;
    end = 1.0e-4;
    maxsamp = 0.0;
    ...
    fclose(fp);
    printf("done. Maximum sample value = %.8lf at fram %d\n", maxsamp, maxframe);
    return 0;
}
